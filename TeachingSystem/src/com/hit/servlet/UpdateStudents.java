...
public class UpdateStudents extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = String.format("update Student set Sname='%s',Mid='%s',Did='%s',Sclass='%s',Semail='%s',Stelephone='%s',Ssex='%s',Sbirthday='%s',Saddress='%s',Syear='%s',SpersonID='%s' where Sid='%s';", 
				Sname,Mid,Did,Sclass,Semail,Stelephone,Ssex,Sbirthday,Saddress,Syear,SpersonID,Sid);
