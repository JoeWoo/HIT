...
<body onload="init()">
	...
	<div id="header">	
		...
		<ul id="nav">
			<li><a href="./chooseQuanxiao.jsp" class="navActive">全校任选</a></li>
				...
				<div id="biao" style="height: 500px;overflow: auto;">
					<table  id="scorestable" style="width:610px;" border="1" cellpadding="0" cellspacing="0">
				        <tbody>
					        ...
					        sql+=String.format(" where Ctype='2' and Term='%s'", DataManager.getTerm());
					        ...
					        while(rs.next()){%>
					            ...
					            <td>
					            	<a href="">详细信息</a>
					            	&nbsp;<a id="<%=rs.getString("Tempid")%>_button" href="javascript:void(0)" onclick="beforeChoose(2);choose(<%=rs.getString("Tempid")%>)">选课</a>
				...
				<div id="biao" style="overflow: auto">
					<table  id="scorestable2" style="width:610px;" border="1" cellpadding="0" cellspacing="0">
				        <tbody id="haschoosed">
					        ...
					        "=TempCourse.Tid";
					        sql+=String.format(" where SC.Sid='%s' and Term='%s' and Ctype='2'" , student.getID(), DataManager.getTerm());
